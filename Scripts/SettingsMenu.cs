...
public partial class SettingsMenu : Control
{
    ...
    {
        new(0.1f,  0.95f, 0.2f),   // verde
        new(0.95f, 0.1f,  0.1f),   // vermelho
        new(1.0f,  0.85f, 0.0f),   // amarelo
        new(0.2f,  0.4f,  1.0f),   // azul
        new(1.0f,  0.5f,  0.0f),   // laranja
    };
    ...
    private readonly Button[] _keyboardButtons = new Button[5];
    private readonly Button[] _gamepadButtons  = new Button[5];
    ...
    private void BuildLaneRows(VBoxContainer parent, Button[] buttons, bool isKeyboard)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                Text              = Locale.Tr(LaneNameKeys[i]),
                CustomMinimumSize = new Vector2(130, 0),
                VerticalAlignment = VerticalAlignment.Center,
            };
            nameLabel.AddThemeFontSizeOverride("font_size", 20);
            nameLabel.AddThemeColorOverride("font_color", LaneColors[i]);
